...
import { type UUID } from '@enxoval/types';
...
import { fromDbWire, toDbWire } from '../adapters/diagnostic-triggered';

const repo = () => AppDataSource.getRepository(DiagnosticTriggeredDbWire);
